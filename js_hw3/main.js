...
// const discount = (age > 0 && age < 18) ? "скидка 10%" : (age >= 18 && age <= 65) ? "скидка 20%" : (age > 65) ? "скидка 30%" : "некорректный возраст";
// console.log(discount)


// решение 2
// const age1 = prompt("Введите свой возраст", 0);
// let discount;
// switch (true) {
//     case (age1 >= 0 && age1 < 18):
//         discount = "скидка 10%";
...
if (weight <= 0) {
    ...
    let deliverType = prompt("Выберите тип доставки (standard, express, premium)", 0);
    let isValidDelivery = true; 

    switch (deliverType) {
        case "standard":
            alert("Выбрана стандартная доставка");
            break;
        case "express":
            alert("Выбрана экспресс доставка");
            break;
        case "premium":
            alert("Выбрана премиум доставка");
            break;
        default:
